...
class PostgresQueryGenerator extends AbstractQueryGenerator {
  ...
  upsertQuery(tableName, insertValues, updateValues, where, model, options) {
    ...
    if (options.conflict.update.columns === false) {
      ...
      console.log('pgUpsert: 1.) options.conflict.update.columns = ' + JSON.stringify(options.conflict.update.columns))
      ...
      console.log('pgUpsert: 2.) options.conflict.update.columns = ' + JSON.stringify(options.conflict.update.columns))
    ...
    console.log('pgUpsert: 3.) options.onConflict = ' + JSON.stringify(options.onConflict))

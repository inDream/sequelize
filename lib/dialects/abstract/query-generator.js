...
class QueryGenerator {
  ...
  insertQuery(table, valueHash, modelAttributes, options) {
    ...
    console.log('abstract_insertQuery_QG: 1.) valueQuery = ' + valueQuery);
    ...
    console.log('abstract_insertQuery_QG: 2.) valueQuery = ' + valueQuery);
    ...
    console.log('abstract_insertQuery_QG: 3.) query = ' + query);

    query = _.template(query, this._templateSettings)(replacements);


    console.log('abstract_insertQuery_QG: 4.) query = ' + query);
    ...
    console.log('abstract_insertQuery_QG: 5.) result = ' + result);
